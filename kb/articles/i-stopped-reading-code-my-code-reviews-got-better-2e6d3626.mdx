...
description: 'Now my code reviews no longer involve reading code. The bug report was deceptively simple: A user noticed that their email signature formatting was of'
icon: 'newspaper'
...
Now my code reviews no longer involve reading code. The bug report was deceptively simple: A user noticed that their email signature formatting was off in **[Cora](https://cora.computer)**, our AI-powered email assistant. I asked Claude Code to investigate and fix it. By morning, the fix had touched 27 files, and more than 1,000 lines of code had cha
