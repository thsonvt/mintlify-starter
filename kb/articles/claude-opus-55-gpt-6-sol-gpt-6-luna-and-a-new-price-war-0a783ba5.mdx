...
description: 'Anthropic''s Claude Opus 5.5 and OpenAI''s GPT-6 models were released with significant price reductions, intensifying competition in AI model pricing.'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-09-22'
sourceUrl: 'https://simonwillison.net/2026/Sep/22/opus-and-sol-and-luna/'
topics: ["ai-models","pricing-strategy","gpt-6","claude-opus","ai-competition"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Sep/22/opus-and-sol-and-luna/) · 22/09/2026
</Info>

## Summary

Anthropic's Claude Opus 5.5 and OpenAI's GPT-6 models were released with significant price reductions, intensifying competition in AI model pricing.

## Key Insights

> "GPT-6 Luna is half the price of that again—and GPT-6 Sol had a similar reduction compared to GPT-5.6 Sol."
>
> — Discussing the pricing of new AI models.

> "Opus 5.5 is the result of your feedback. It communicates clearly, it’s cheaper per token than Opus 5.0."
>
> — Feedback on improvements in Claude Opus 5.5.

> "Claude Opus 5.5 max over-thinks to the point of breaking."
>
> — Critique of the performance of Claude Opus 5.5 at maximum reasoning level.
...
- [claude-opus](/kb/topics/claude-opus)
...
<Note>
Originally published at [https://simonwillison.net/2026/Sep/22/opus-and-sol-and-luna/](https://simonwillison.net/2026/Sep/22/opus-and-sol-and-luna/).
</Note>
