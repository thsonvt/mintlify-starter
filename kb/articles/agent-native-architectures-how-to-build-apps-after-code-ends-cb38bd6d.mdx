...
topics: ["Anti-patterns","Storage Abstraction","Dynamic Capability Discovery","CRUD Completeness","Agent-Native Architecture"]
diataxisType: 'how-to'
---
...
>
> — Discussing the trade-offs in storing agent configurations for flexibility and robustness.

> "Use a storage abstraction layer. Don't use raw FileManager."
>
> — Advising on the importance of abstraction in storage for flexibility across different storage solutions.

> "Dynamic capability discovery: // Two tools handle everything"
>
> — Introducing the concept of dynamic capability discovery to adapt to new data types and capabilities.

> "Common failure: You build `create_note` and `read_notes` but forget `update_note` and `delete_note`."
>
> — Highlighting a common oversight in CRUD operations that limits agent capabilities.

## Topics

- [Anti-patterns](/kb/topics/anti-patterns)
...
*Context: Discussing the trade-offs in storing agent configurations for flexibility and robustness.*

> Use a storage abstraction layer. Don't use raw FileManager.

*Context: Advising on the importance of abstraction in storage for flexibility across different storage solutions.*

> Dynamic capability discovery: // Two tools handle everything

*Context: Introducing the concept of dynamic capability discovery to adapt to new data types and capabilities.*

> Common failure: You build `create_note` and `read_notes` but forget `update_note` and `delete_note`.

*Context: Highlighting a common oversight in CRUD operations that limits agent capabilities.*
...
<CardGroup cols={1}>
  ...
  >
    Naveen Naidu · tutorial · 81% similar
  </Card>
  <Card
