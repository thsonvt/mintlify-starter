...
description: 'Simon Willison successfully ported the Moebius 0.2B image inpainting model to run in the browser using Claude Code, enabling users to inpaint images d'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-06-22'
sourceUrl: 'https://simonwillison.net/2026/Jun/22/porting-moebius/#atom-everything'
topics: ["image-inpainting","webgpu","ai-agents","browser-compatibility"]
diataxisType: 'how-to'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Jun/22/porting-moebius/#atom-everything) · 22/06/2026
</Info>

## Summary

Simon Willison successfully ported the Moebius 0.2B image inpainting model to run in the browser using Claude Code, enabling users to inpaint images directly online.

## Key Insights

> "I got it working, and you can try the demo at simonw.github.io/moebius-web/"
>
> — Announcement of the successful implementation of the Moebius model in the browser.

> "Claude suggested using ONNX Runtime Web on the WebGPU backend."
>
> — Description of the guidance received from Claude Code during the project.

> "After a few rounds of iteration, we got to a working, deployed version!"
>
> — Reflection on the iterative process leading to the successful deployment of the project.

## Topics

- [image-inpainting](/kb/topics/image-inpainting)
- [webgpu](/kb/topics/webgpu)
...
<Note>
Originally published at [https://simonwillison.net/2026/Jun/22/porting-moebius/#atom-everything](https://simonwillison.net/2026/Jun/22/porting-moebius/#atom-everything).
</Note>
