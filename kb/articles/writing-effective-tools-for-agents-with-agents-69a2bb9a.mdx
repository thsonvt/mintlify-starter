...
description: 'Tools are a new kind of software which reflects a contract between deterministic systems and non-deterministic agents. The Model Context Protocol (MCP'
icon: 'newspaper'
author: 'Anthropic Engineering'
authorId: 'anthropic-engineering'
published: '2026-01-29'
sourceUrl: 'https://www.anthropic.com/engineering/writing-tools-for-agents'
topics: ["Prompt Engineering","Agent-Native Architecture","Anthropic API","AI Agents"]
diataxisType: 'how-to'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/writing-tools-for-agents) · 29/01/2026
</Info>

## Summary

Tools are a new kind of software which reflects a contract between deterministic systems and non-deterministic agents. The Model Context Protocol (MCP) can empower LLM agents with potentially hundreds of tools to solve real-world tasks. But how do we make those tools maximally effective? In this post, we describe our most effective techniques for improving performance in a variety of agentic AI systems 1 . We begin

## Key Insights

> "Tools are a new kind of software which reflects a contract between deterministic systems and non-deterministic agents."
>
> — Describing the overarching goal of developing tools for AI agents.
...
>
> — Highlighting the importance of evaluation in the tool development process for AI agents.
...
<Note>
Originally published at [https://www.anthropic.com/engineering/writing-tools-for-agents](https://www.anthropic.com/engineering/writing-tools-for-agents).
</Note>
