...
description: 'Simon Willison introduces the llm-coding-agent 0.1a0, a Python library for building coding agents using LLMs, showcasing its capabilities and tools.'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-07-02'
sourceUrl: 'https://simonwillison.net/2026/Jul/2/llm-coding-agent/#atom-everything'
topics: ["llm-agents","python-library","tdd","openai-api"]
diataxisType: 'how-to'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Jul/2/llm-coding-agent/#atom-everything) · 02/07/2026
</Info>

## Summary

Simon Willison introduces the llm-coding-agent 0.1a0, a Python library for building coding agents using LLMs, showcasing its capabilities and tools.
...
>
> — Introduction of the new coding agent and its installation command.
...
>
> — Description of the unexpected yet welcomed features of the coding agent.

> "SwiftUI isn't suitable for a true CLI"
>
> — GPT-5.5's reasoning during the development of a CLI app.
...
<Note>
Originally published at [https://simonwillison.net/2026/Jul/2/llm-coding-agent/#atom-everything](https://simonwillison.net/2026/Jul/2/llm-coding-agent/#atom-everything).
</Note>
