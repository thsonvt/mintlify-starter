...
<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Aug/10/introducing-muse-glimmer/#atom-everything) · 10/08/2026
</Info>
...
> "I really like this size of model, because if a machine has 32 GB of RAM or more, it leaves plenty of space for running other applications."
>
> — Discussing the advantages of the model's size for practical use.
...
<Note>
Originally published at [https://simonwillison.net/2026/Aug/10/introducing-muse-glimmer/#atom-everything](https://simonwillison.net/2026/Aug/10/introducing-muse-glimmer/#atom-everything).
</Note>
