...
description: 'OpenAI has significantly reduced the prices of its GPT models, with GPT-5.6 seeing cuts of up to 80%, driven by advancements in self-optimization and '
icon: 'newspaper'
author: 'Swyx'
authorId: 'swyx'
published: '2026-07-31'
sourceUrl: 'https://www.latent.space/p/ainews-gpt-56-price-cut-by-20-80'
topics: ["openai","gpt-5-6","ai-pricing","self-optimization","model-efficiency"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Swyx](https://www.latent.space/p/ainews-gpt-56-price-cut-by-20-80) · 31/07/2026
</Info>

## Summary

OpenAI has significantly reduced the prices of its GPT models, with GPT-5.6 seeing cuts of up to 80%, driven by advancements in self-optimization and efficiency.

## Key Insights

> "OpenAI cut GPT-5.6 prices aggressively and added a faster Sol tier."
>
> — AI Twitter Recap
...
> "The takeaway echoed by @gneubig, @scaling01, and others: long-horizon evals increasingly measure the complete agent system."
>
...
- [self-optimization](/kb/topics/self-optimization)
...
<CardGroup cols={1}>
  ...
  >
    Simon Willison · explanation · 86% similar
  </Card>
  <Card
...
<Note>
Originally published at [https://www.latent.space/p/ainews-gpt-56-price-cut-by-20-80](https://www.latent.space/p/ainews-gpt-56-price-cut-by-20-80).
</Note>
