...
description: 'The core challenge of long-running agents is that they must work in discrete sessions, and each new session begins with no memory of what came before.'
icon: 'newspaper'
...
topics: ["AI Development","Incremental Development","Task Management for AI Agents","Software Engineering Practices"]
diataxisType: 'how-to'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents) · 01/02/2026
</Info>

## Summary

The core challenge of long-running agents is that they must work in discrete sessions, and each new session begins with no memory of what came before. As AI agents become more capable, developers are increasingly asking them to take on complex tasks requiring work that spans hours, or even days. However, getting agents to make consistent progress across multiple context windows remains an open problem. The core challenge of long-running agents is

## Key Insights

> "The core challenge of long-running agents is that they must work in discrete sessions, and each new session begins with no memory of what came before."
>
> — Describing the primary challenge in managing long-running AI agents.

> "We developed a two-fold solution to enable the Claude Agent SDK to work effectively across many context windows."
>
> — Introducing their solution to the challenge of long-running AI agents.

> "This happens even with compaction, which doesn’t always pass perfectly clear instructions to the next agent."
>
> — Highlighting a failure mode in their approach, where context compaction doesn't fully solve continuity issues.

## Topics

- [AI Development](/kb/topics/ai-development)
- [Incremental Development](/kb/topics/incremental-development)
- [Task Management for AI Agents](/kb/topics/task-management-for-ai-agents)
- [Software Engineering Practices](/kb/topics/software-engineering-practices)
...
<CardGroup cols={1}>
  ...
  >
    Anthropic Engineering · tutorial · 85% similar
  </Card>
  <Card
  ...
  >
    Anthropic Engineering · explanation · 83% similar
  </Card>
  <Card
  ...
  >
    Anthropic Engineering · explanation · 82% similar
  </Card>
</CardGroup>
...
<Note>
Originally published at [https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents).
</Note>
