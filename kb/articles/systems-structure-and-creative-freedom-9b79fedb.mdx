...
description: 'Only when I learned to build walls – not out of fear, but focus – could my storms take shape. ![Creative Process](https://res.cloudinary.com/dhcx3vzmg'
icon: 'newspaper'
...
Only when I learned to build walls – not out of fear, but focus – could my storms take shape. ![Creative Process](https://res.cloudinary.com/dhcx3vzmg/image/upload/v1708099423/acinziwryumm1luzumdn.jpg)
...
<CardGroup cols={1}>
  ...
  >
    Kieran Klaassen · how-to · 72% similar
  </Card>
</CardGroup>
