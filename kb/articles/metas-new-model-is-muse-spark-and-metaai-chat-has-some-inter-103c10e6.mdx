...
description: 'Meta has launched Muse Spark, a new AI model with competitive benchmarks and various tools for users, including image generation and code execution.'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-04-08'
sourceUrl: 'https://simonwillison.net/2026/Apr/8/muse-spark/#atom-everything'
topics: ["ai-models","meta-ai","image-generation","api-tools"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Apr/8/muse-spark/#atom-everything) · 08/04/2026
</Info>

## Summary

Meta has launched Muse Spark, a new AI model with competitive benchmarks and various tools for users, including image generation and code execution.

## Key Insights

> "Meta promise a 'Contemplating' mode in the future which they say will offer much longer reasoning time."
>
> — Discussing the future capabilities of the Muse Spark model.

> "Meta's self-reported benchmarks show it competitive with Opus 4.6, Gemini 3.1 Pro, and GPT 5.4."
>
> — Comparing Muse Spark's performance with other AI models.

> "Meta AI can create HTML+JavaScript files in its container which can then be served up as secure sandboxed iframe interactives."
>
> — Explaining the capabilities of the tools available in Muse Spark.
...
<Note>
Originally published at [https://simonwillison.net/2026/Apr/8/muse-spark/#atom-everything](https://simonwillison.net/2026/Apr/8/muse-spark/#atom-everything).
</Note>
