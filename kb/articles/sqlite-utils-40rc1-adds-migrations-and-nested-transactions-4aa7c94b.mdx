...
description: 'sqlite-utils 4.0rc1 introduces database migrations and atomic transactions, enhancing SQLite database management with new features and minor breaking '
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-06-21'
sourceUrl: 'https://simonwillison.net/2026/Jun/21/sqlite-utils-40rc1/#atom-everything'
topics: ["sqlite","python","database-migrations","transactions"]
diataxisType: 'reference'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Jun/21/sqlite-utils-40rc1/#atom-everything) · 21/06/2026
</Info>

## Summary

sqlite-utils 4.0rc1 introduces database migrations and atomic transactions, enhancing SQLite database management with new features and minor breaking changes.

## Key Insights

> "The first is support for database migrations."
>
> — Introduction of new features in sqlite-utils 4.0rc1.

> "SQLite supports nested transactions in the form of savepoints."
>
> — Explanation of the new atomic transactions feature.

> "The backwards incompatible changes in v4 were described in the alpha release notes."
>
> — Discussion of changes in the new version.
...
<Note>
Originally published at [https://simonwillison.net/2026/Jun/21/sqlite-utils-40rc1/#atom-everything](https://simonwillison.net/2026/Jun/21/sqlite-utils-40rc1/#atom-everything).
</Note>
