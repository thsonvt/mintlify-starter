...
description: 'For an AI model to be useful in specific contexts, it often needs access to background knowledge. ![](https://www-cdn.anthropic.com/images/4zrzovbb/we'
icon: 'newspaper'
...
<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/contextual-retrieval) · 21/02/2026
</Info>

## Summary

For an AI model to be useful in specific contexts, it often needs access to background knowledge. ![](https://www-cdn.anthropic.com/images/4zrzovbb/website/7e2e39544a35760367049072406377a54f2b58c0-2554x2554.svg)

## Key Insights

> "For an AI model to be useful in specific contexts, it often needs access to background knowledge."
>
> — Explaining the necessity of background knowledge for AI models.

> "Contextual Retrieval can reduce the number of failed retrievals by 49%."
>
> — Highlighting the effectiveness of Contextual Retrieval.

> "Sometimes the simplest solution is the best."
>
> — Discussing the approach of using longer prompts for smaller knowledge bases.
...
![A Standard Retrieval-Augmented Generation (RAG) system that uses both embeddings and Best Match 25 (BM25) to retrieve information. TF-IDF (term frequency-inverse document frequency) measures word importance and forms the basis for BM25.](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F45603646e979c62349ce27744a940abf30200d57-3840x2160.png&w=3840&q=75)
...
![Contextual Retrieval is a preprocessing technique that improves retrieval accuracy.](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F2496e7c6fedd7ffaa043895c23a4089638b0c21b-3840x2160.png&w=3840&q=75)
...
![Combining Contextual Embedding and Contextual BM25 reduce the top-20-chunk retrieval failure rate by 49%.](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F7f8d739e491fe6b3ba0e6a9c74e4083d760b88c9-3840x2160.png&w=3840&q=75)
...
![Combine Contextual Retrieva and Reranking to maximize retrieval accuracy.](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F8f82c6175a64442ceff4334b54fac2ab3436a1d1-3840x2160.png&w=3840&q=75)
...
![Reranked Contextual Embedding and Contextual BM25 reduces the top-20-chunk retrieval failure rate by 67%.](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F93a70cfbb7cca35bb8d86ea0a23bdeeb699e8e58-3840x2160.png&w=3840&q=75)
...
![1 minus recall @ 20 results across data sets and embedding providers.](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F646a894ec4e6120cade9951a362f685cd2ec89b2-2458x2983.png&w=3840&q=75)
...
*Context: Explaining the necessity of background knowledge for AI models.*

> Contextual Retrieval can reduce the number of failed retrievals by 49%.

*Context: Highlighting the effectiveness of Contextual Retrieval.*

> Sometimes the simplest solution is the best.

*Context: Discussing the approach of using longer prompts for smaller knowledge bases.*
...
<Note>
Originally published at [https://www.anthropic.com/engineering/contextual-retrieval](https://www.anthropic.com/engineering/contextual-retrieval).
</Note>
