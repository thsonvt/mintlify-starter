...
description: 'The article discusses the controversy surrounding OpenAI''s resolution of the Navier–Stokes problem, highlighting accusations of data misuse from colla'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-09-08'
sourceUrl: 'https://simonwillison.net/2026/Sep/8/on-navier-stokes/'
topics: ["navier-stokes","millennium-prize","openai","ai-research","data-ethics"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Sep/8/on-navier-stokes/) · 08/09/2026
</Info>

## Summary

The article discusses the controversy surrounding OpenAI's resolution of the Navier–Stokes problem, highlighting accusations of data misuse from collaborating mathematicians.

## Key Insights

> "I asked whether the model had been trained on, or had access to, our sessions in Codex."
>
> — Tristan Buckmaster's inquiry about OpenAI's use of their data.

> "Our effort began on September 1st after hearing a rumor which we later realized was related to Levent Alpöge."
>
> — OpenAI's acknowledgment of the timeline regarding their work on the problem.

> "This situation appears to mirror what's happening in the world of computer security right now."
>
> — The author's reflection on the implications of AI in solving mathematical problems.
...
<Note>
Originally published at [https://simonwillison.net/2026/Sep/8/on-navier-stokes/](https://simonwillison.net/2026/Sep/8/on-navier-stokes/).
</Note>
