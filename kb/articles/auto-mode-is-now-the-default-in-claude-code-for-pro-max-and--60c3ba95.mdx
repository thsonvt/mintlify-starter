...
description: 'Claude Code''s auto mode becomes the default setting for Pro, Max, and Team plans, significantly improving safety against harmful actions and prompt in'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-08-08'
sourceUrl: 'https://simonwillison.net/2026/Aug/8/auto-mode/#atom-everything'
topics: ["auto-mode","claude-code","ai-safety","prompt-injection"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Aug/8/auto-mode/#atom-everything) · 08/08/2026
</Info>

## Summary

Claude Code's auto mode becomes the default setting for Pro, Max, and Team plans, significantly improving safety against harmful actions and prompt injection.

## Key Insights

> "Broadly within Anthropic, almost every single person uses auto mode."
>
> — Cat Wu discussing the widespread adoption of auto mode within the company.

> "Auto mode would have blocked 89% of those actions."
>
> — The article highlights the effectiveness of auto mode in preventing harmful actions.

> "I would love to believe that Anthropic have indeed solved this problem for Claude Code users."
>
> — The author expresses hope for the effectiveness of Claude Code's safety measures.

## Topics

- [auto-mode](/kb/topics/auto-mode)
...
<Note>
Originally published at [https://simonwillison.net/2026/Aug/8/auto-mode/#atom-everything](https://simonwillison.net/2026/Aug/8/auto-mode/#atom-everything).
</Note>
