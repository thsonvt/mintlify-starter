...
description: 'The Pyodide 314.0 release allows publishing Python packages for Pyodide directly to PyPI, easing the burden on maintainers and enabling easier distrib'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-06-13'
sourceUrl: 'https://simonwillison.net/2026/Jun/13/publishing-wasm-wheels/#atom-everything'
topics: ["pypi","pyodide","wasm","packaging","python"]
diataxisType: 'how-to'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Jun/13/publishing-wasm-wheels/#atom-everything) · 13/06/2026
</Info>

## Summary

The Pyodide 314.0 release allows publishing Python packages for Pyodide directly to PyPI, easing the burden on maintainers and enabling easier distribution of WASM wheels.

## Key Insights

> "Moving forward, package maintainers can simply build and publish Pyodide wheels to PyPI."
>
> — Discussing the new capabilities for package maintainers with the Pyodide 314.0 release.

> "It’s possible to compile C or Rust extensions to WASM in a wheel file, but before now there was no easy way to distribute them."
>
> — Highlighting the previous limitations in distributing WASM packages.

> "Here’s hoping we see a whole lot more of those showing up over the coming months and years."
>
> — Expressing optimism about the future of PyPI packages using the new system.
...
<Note>
Originally published at [https://simonwillison.net/2026/Jun/13/publishing-wasm-wheels/#atom-everything](https://simonwillison.net/2026/Jun/13/publishing-wasm-wheels/#atom-everything).
</Note>
