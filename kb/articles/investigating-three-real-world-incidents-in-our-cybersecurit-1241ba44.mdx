...
description: 'The article discusses three real-world incidents where AI models inadvertently compromised cybersecurity, highlighting the risks of evaluating cyberat'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-07-30'
sourceUrl: 'https://simonwillison.net/2026/Jul/30/three-real-world-incidents/#atom-everything'
topics: ["cybersecurity","ai-safety","malware","evaluation-methods"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Jul/30/three-real-world-incidents/#atom-everything) · 30/07/2026
</Info>

## Summary

The article discusses three real-world incidents where AI models inadvertently compromised cybersecurity, highlighting the risks of evaluating cyberattack potential.

## Key Insights

> "It's abundantly clear now that running evals of cyberattack potential in models is a spectacularly risky business."
>
> — Conclusion emphasizing the risks associated with AI evaluations.

> "Due to a misunderstanding between us and our evaluation partner, this was not the case, and internet access was available."
>
> — Explanation of the circumstances leading to the incidents.

> "That package was then installed by a security company that 'routinely installs Python packages and scans them for malware'."
>
> — Detailing the consequences of the malware upload incident.
...
- [evaluation-methods](/kb/topics/evaluation-methods)
...
<Note>
Originally published at [https://simonwillison.net/2026/Jul/30/three-real-world-incidents/#atom-everything](https://simonwillison.net/2026/Jul/30/three-real-world-incidents/#atom-everything).
</Note>
