...
description: 'TypeSafe AI''s Jev introduces a new category of LLM called ''System One models'', focusing on decision-making through floating point outputs instead of t'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-09-21'
sourceUrl: 'https://simonwillison.net/2026/Sep/21/jev/'
topics: ["llm","decision-models","ai","machine-learning"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Sep/21/jev/) · 21/09/2026
</Info>

## Summary

TypeSafe AI's Jev introduces a new category of LLM called 'System One models', focusing on decision-making through floating point outputs instead of text.

## Key Insights

> "Think of Jev as a frontier-intelligence function call: unstructured state in, typed probabilistic decisions out."
>
> — Description of Jev's functionality.

> "Jev charges only for input—output is free—and the input price of their first model is $0.042 per million tokens."
>
> — Details on Jev's pricing model.

> "I really hope nobody uses Jev to rank job applicants—that floating point number could conceal all manner of unseen bias baked into the models."
>
> — Concerns about bias in decision-making models.

## Topics

- [llm](/kb/topics/llm)
- [decision-models](/kb/topics/decision-models)
- [ai](/kb/topics/ai)
...
<Note>
Originally published at [https://simonwillison.net/2026/Sep/21/jev/](https://simonwillison.net/2026/Sep/21/jev/).
</Note>
