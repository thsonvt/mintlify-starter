...
description: 'The future belongs to people who can just do things. ![](https://ghuntley.com/content/images/2025/06/DSC05426-Enhanced-NR-1.jpg)'
icon: 'newspaper'
author: 'Geoffrey Huntley'
authorId: 'geoffrey-huntley'
published: '2025-06-17'
sourceUrl: 'https://ghuntley.com/six-month-recap/'
topics: ["AI in Software Development","Future of Software Engineering","Impact of Large Language Models"]
...
The future belongs to people who can just do things. ![](https://ghuntley.com/content/images/2025/06/DSC05426-Enhanced-NR-1.jpg)

## Key Insights

> "The future belongs to people who can just do things."
>
> — Discussing the transformative impact of AI on software engineering practices.

> "We are in an 'oh fuck' moment in time."
>
> — Reflecting on the rapid changes AI is bringing to software development.
...
>
> — Highlighting the significant advancements in AI and its readiness to disrupt software engineering.
...
*Context: Discussing the transformative impact of AI on software engineering practices.*

> We are in an 'oh fuck' moment in time.

*Context: Reflecting on the rapid changes AI is bringing to software development.*

> If AI and AI developer tooling were to cease improving today, then it would already be good enough to disrupt our profession completely.

*Context: Highlighting the significant advancements in AI and its readiness to disrupt software engineering.*
