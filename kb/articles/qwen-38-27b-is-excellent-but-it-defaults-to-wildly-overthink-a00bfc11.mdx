...
description: 'Qwen 3.8 27B is a powerful LLM that excels in generating complex outputs but defaults to an overly analytical reasoning mode that can hinder performan'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-08-16'
sourceUrl: 'https://simonwillison.net/2026/Aug/16/qwen-38-27b/'
topics: ["llm","model-evaluation","ai-research","reasoning-effort"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Aug/16/qwen-38-27b/) · 16/08/2026
</Info>

## Summary

Qwen 3.8 27B is a powerful LLM that excels in generating complex outputs but defaults to an overly analytical reasoning mode that can hinder performance on consumer hardware.

## Key Insights

> "This is a hilarious default. It’s absolutely not a good way to run the model, especially on consumer hardware."
>
> — On the reasoning effort default setting of Qwen 3.8 27B.

> "My strong recommendation: ignore that default. Run Qwen 3.8 27B on low or even no reasoning levels at first."
>
> — Advice on how to effectively use the model.

> "It’s very good at bounding boxes."
>
> — Commenting on the model's performance in visual tasks.
...
- [reasoning-effort](/kb/topics/reasoning-effort)
...
<Note>
Originally published at [https://simonwillison.net/2026/Aug/16/qwen-38-27b/](https://simonwillison.net/2026/Aug/16/qwen-38-27b/).
</Note>
