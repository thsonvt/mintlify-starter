...
description: 'We never reduce model quality due to demand, time of day, or server load. Between August and early September, three infrastructure bugs intermittently'
icon: 'newspaper'
author: 'Anthropic Engineering'
authorId: 'anthropic-engineering'
published: '2026-02-02'
sourceUrl: 'https://www.anthropic.com/engineering/a-postmortem-of-three-recent-issues'
topics: ["API Performance","Infrastructure Bugs","Claude Code"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/a-postmortem-of-three-recent-issues) · 02/02/2026
</Info>

## Summary

We never reduce model quality due to demand, time of day, or server load. Between August and early September, three infrastructure bugs intermittently degraded Claude's response quality. We've now resolved these issues and want to explain what happened.

## Key Insights

> "We never reduce model quality due to demand, time of day, or server load."
>
> — Clarifying that the issues were strictly due to infrastructure bugs.

> "The overlapping nature of these bugs made diagnosis particularly challenging."
>
> — Describing the complexity in identifying and resolving the issues.

> "We've added detection tests for unexpected character outputs to our deployment process."
>
> — Detailing a specific improvement made to prevent future issues.

## Topics

- [API Performance](/kb/topics/api-performance)
- [Infrastructure Bugs](/kb/topics/infrastructure-bugs)
...
*Context: Clarifying that the issues were strictly due to infrastructure bugs.*

> The overlapping nature of these bugs made diagnosis particularly challenging.

*Context: Describing the complexity in identifying and resolving the issues.*

> We've added detection tests for unexpected character outputs to our deployment process.

*Context: Detailing a specific improvement made to prevent future issues.*

## Related Topics

- [[topics/api-performance]]
- [[topics/infrastructure-bugs]]
- [[topics/claude-code]]
...
<Note>
Originally published at [https://www.anthropic.com/engineering/a-postmortem-of-three-recent-issues](https://www.anthropic.com/engineering/a-postmortem-of-three-recent-issues).
</Note>
