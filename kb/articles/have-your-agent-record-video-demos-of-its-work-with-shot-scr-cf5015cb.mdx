...
description: 'The article discusses the new ''shot-scraper video'' command in the shot-scraper 1.10 release, which allows coding agents to record video demos of web a'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-06-30'
sourceUrl: 'https://simonwillison.net/2026/Jun/30/shot-scraper-video/#atom-everything'
topics: ["video-demos","playwright","coding-agents","automation","datasette"]
diataxisType: 'how-to'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Jun/30/shot-scraper-video/#atom-everything) · 30/06/2026
</Info>

## Summary

The article discusses the new 'shot-scraper video' command in the shot-scraper 1.10 release, which allows coding agents to record video demos of web application routines using Playwright.
...
>
> — Introduction to the article's purpose

> "This was a great example of the kind of feature that I almost certainly wouldn’t have taken on without coding agent support."
>
> — Reflection on the role of coding agents in development

> "The YAML format itself was mostly defined by the coding agent."
>
> — Discussion on the use of coding agents in defining formats

## Topics

- [video-demos](/kb/topics/video-demos)
- [playwright](/kb/topics/playwright)
...
<Note>
Originally published at [https://simonwillison.net/2026/Jun/30/shot-scraper-video/#atom-everything](https://simonwillison.net/2026/Jun/30/shot-scraper-video/#atom-everything).
</Note>
