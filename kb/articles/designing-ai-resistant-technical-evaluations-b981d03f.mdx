...
description: 'Evaluating technical candidates becomes harder as AI capabilities improve. *Written by Tristan Hume, a lead on Anthropic''s performance optimization te'
icon: 'newspaper'
author: 'Anthropic Engineering'
authorId: 'anthropic-engineering'
published: '2026-02-02'
sourceUrl: 'https://www.anthropic.com/engineering/AI-resistant-technical-evaluations'
topics: ["Technical Hiring","Performance Engineering","AI Agents","Claude Code"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/AI-resistant-technical-evaluations) · 02/02/2026
</Info>

## Summary

Evaluating technical candidates becomes harder as AI capabilities improve. *Written by Tristan Hume, a lead on Anthropic's performance optimization team. Tristan designed—and redesigned—the take-home test that's helped Anthropic hire dozens of performance engineers.*

## Key Insights

> "Evaluating technical candidates becomes harder as AI capabilities improve."
>
> — Introduction to the challenge of designing AI-resistant evaluations.

> "Each new Claude model has forced us to redesign the test."
>
> — Discussing the need to evolve technical tests in response to AI advancements.

> "Humans can still outperform models when given unlimited time."
>
> — Highlighting the unique capabilities humans bring to problem-solving.

## Topics

- [Technical Hiring](/kb/topics/technical-hiring)
...
*Context: Introduction to the challenge of designing AI-resistant evaluations.*

> Each new Claude model has forced us to redesign the test.

*Context: Discussing the need to evolve technical tests in response to AI advancements.*

> Humans can still outperform models when given unlimited time.

*Context: Highlighting the unique capabilities humans bring to problem-solving.*
...
<CardGroup cols={1}>
  ...
  >
    Anthropic Engineering · how-to · 73% similar
  </Card>
  <Card
...
<Note>
Originally published at [https://www.anthropic.com/engineering/AI-resistant-technical-evaluations](https://www.anthropic.com/engineering/AI-resistant-technical-evaluations).
</Note>
