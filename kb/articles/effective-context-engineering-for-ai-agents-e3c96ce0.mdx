...
description: 'Building with language models is becoming less about finding the right words and phrases for your prompts, and more about answering the broader questi'
icon: 'newspaper'
...
topics: ["Context Engineering","AI Agents","Transformer Architecture","Prompt Engineering"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents) · 02/02/2026
</Info>

## Summary

Building with language models is becoming less about finding the right words and phrases for your prompts, and more about answering the broader question of “what configuration of context is most likel After a few years of prompt engineering being the focus of attention in applied AI, a new term has come to prominence: **context engineering**. Building with language models is becoming less about finding the right words and phrases for your prompts, and more about answering the broader question of
...
>
> — Introduction to the concept of context engineering versus traditional prompt engineering.
...
>
> — Defining context engineering and its iterative nature compared to prompt engineering.
...
>
> — Comparing LLMs' attention budget to human working memory to illustrate the challenges of context management.

## Topics

- [Context Engineering](/kb/topics/context-engineering)
- [AI Agents](/kb/topics/ai-agents)
- [Transformer Architecture](/kb/topics/transformer-architecture)
...
*Context: Introduction to the concept of context engineering versus traditional prompt engineering.*

> Context engineering is the art and science of curating what will go into the limited context window from that constantly evolving universe of possible information.

*Context: Defining context engineering and its iterative nature compared to prompt engineering.*

> Like humans, who have limited working memory capacity, LLMs have an “attention budget” that they draw on when parsing large volumes of context.

*Context: Comparing LLMs' attention budget to human working memory to illustrate the challenges of context management.*
...
<CardGroup cols={1}>
  ...
  >
    Jesse Chen · explanation · 77% similar
  </Card>
  <Card
...
<Note>
Originally published at [https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents).
</Note>
