...
description: 'Infrastructure configuration can swing agentic coding benchmarks by several percentage points—sometimes more than the leaderboard gap between top mode'
icon: 'newspaper'
author: 'Anthropic Engineering'
authorId: 'anthropic-engineering'
published: '2026-02-12'
sourceUrl: 'https://www.anthropic.com/engineering/infrastructure-noise'
topics: ["Agent-Native Architecture","AI Agents","Software Engineering Benchmarks"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/infrastructure-noise) · 12/02/2026
</Info>

## Summary

Infrastructure configuration can swing agentic coding benchmarks by several percentage points—sometimes more than the leaderboard gap between top models. Infrastructure configuration can swing agentic coding benchmarks by several percentage points—sometimes more than the leaderboard gap between top models.
...
>
> — Highlighting the significant impact of infrastructure setup on coding benchmarks.

> "Two agents with different resource budgets and time limits aren't taking the same test."
>
> — Emphasizing the inequality in testing conditions due to varied resource allocations.

> "The extra resources enable the agent to try approaches that only work with generous allocations."
>
> — Discussing how resource availability can change the strategies an AI agent might employ.

## Topics

- [Agent-Native Architecture](/kb/topics/agent-native-architecture)
- [AI Agents](/kb/topics/ai-agents)
- [Software Engineering Benchmarks](/kb/topics/software-engineering-benchmarks)
...
*Context: Highlighting the significant impact of infrastructure setup on coding benchmarks.*

> Two agents with different resource budgets and time limits aren't taking the same test.

*Context: Emphasizing the inequality in testing conditions due to varied resource allocations.*

> The extra resources enable the agent to try approaches that only work with generous allocations.

*Context: Discussing how resource availability can change the strategies an AI agent might employ.*
...
<Note>
Originally published at [https://www.anthropic.com/engineering/infrastructure-noise](https://www.anthropic.com/engineering/infrastructure-noise).
</Note>
