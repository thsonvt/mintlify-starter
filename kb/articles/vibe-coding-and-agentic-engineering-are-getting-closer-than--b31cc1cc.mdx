...
description: 'Simon Willison discusses the convergence of vibe coding and agentic engineering, reflecting on the implications for software quality and accountabilit'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-05-06'
sourceUrl: 'https://simonwillison.net/2026/May/6/vibe-coding-and-agentic-engineering/#atom-everything'
topics: ["ai-coding-tools","vibe-coding","agentic-engineering","software-quality"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/May/6/vibe-coding-and-agentic-engineering/#atom-everything) · 06/05/2026
</Info>

## Summary

Simon Willison discusses the convergence of vibe coding and agentic engineering, reflecting on the implications for software quality and accountability in AI-assisted programming.

## Key Insights

> "vibe coding is grossly irresponsible because it’s other people’s information."
>
> — Discussing the risks of vibe coding in production environments.

> "I want to build higher quality stuff faster."
>
> — Expressing the goal of improving software quality while leveraging AI tools.

> "Claude Code does not have a professional reputation!"
>
> — Highlighting the lack of accountability in AI coding agents compared to human engineers.
...
<Note>
Originally published at [https://simonwillison.net/2026/May/6/vibe-coding-and-agentic-engineering/#atom-everything](https://simonwillison.net/2026/May/6/vibe-coding-and-agentic-engineering/#atom-everything).
</Note>
