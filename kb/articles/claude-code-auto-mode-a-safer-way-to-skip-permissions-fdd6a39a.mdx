...
description: 'By default, Claude Code asks users for approval before running commands or modifying files. By default, Claude Code asks users for approval before run'
icon: 'newspaper'
author: 'Anthropic Engineering'
authorId: 'anthropic-engineering'
published: '2026-03-26'
sourceUrl: 'https://www.anthropic.com/engineering/claude-code-auto-mode'
topics: ["Software Development Practices","User Experience Design","Machine Learning Models","Security Measures","AI Safety"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/claude-code-auto-mode) · 26/03/2026
</Info>

## Summary

By default, Claude Code asks users for approval before running commands or modifying files. By default, Claude Code asks users for approval before running commands or modifying files. This keeps users safe, but it also means a lot of clicking "approve." Over time that leads to approval fatigue, where people stop paying close attention to what they're approving. Users have two solutions for

## Key Insights

> "By default, Claude Code asks users for approval before running commands or modifying files."
>
> — Describing the default safety measures in Claude Code to prevent unauthorized actions.
...
>
> — Introducing Auto mode as a solution to reduce user fatigue from constant approval prompts while maintaining safety.
...
>
> — Explaining how the Auto mode's classifier is designed to prevent unintended actions by the AI.

## Topics

- [Software Development Practices](/kb/topics/software-development-practices)
- [User Experience Design](/kb/topics/user-experience-design)
- [Machine Learning Models](/kb/topics/machine-learning-models)
- [Security Measures](/kb/topics/security-measures)
...
<Note>
Originally published at [https://www.anthropic.com/engineering/claude-code-auto-mode](https://www.anthropic.com/engineering/claude-code-auto-mode).
</Note>
