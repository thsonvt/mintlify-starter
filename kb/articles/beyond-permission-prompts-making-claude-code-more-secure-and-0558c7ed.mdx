...
description: 'Sandboxing safely reduces permission prompts by 84%. In [Claude Code](https://www.claude.com/product/claude-code), Claude writes, tests, and debugs co'
icon: 'newspaper'
author: 'Anthropic Engineering'
authorId: 'anthropic-engineering'
published: '2026-02-02'
sourceUrl: 'https://www.anthropic.com/engineering/claude-code-sandboxing'
topics: ["AI Agents","Claude Code","Open Source","Sandboxing"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/claude-code-sandboxing) · 02/02/2026
</Info>

## Summary

Sandboxing safely reduces permission prompts by 84%. In [Claude Code](https://www.claude.com/product/claude-code), Claude writes, tests, and debugs code alongside you, navigating your codebase, editing multiple files, and running commands to verify its work. Giving Claude this much access to your codebase and files can introduce risks, especially in t

## Key Insights

> "Sandboxing safely reduces permission prompts by 84%."
>
> — Highlighting the effectiveness of sandboxing in improving security and reducing interruptions.

> "Effective sandboxing requires both filesystem and network isolation."
>
> — Explaining the dual necessity for comprehensive sandboxing to ensure security.

> "We believe that others should consider adopting this technology for their own agents."
>
> — Encouraging the adoption of sandboxing technology by others to enhance security.
...
2. Go to [claude.com/code](http://claude.ai/redirect/website.v1.db54c16f-a791-40de-aa29-5b838b946b42/code) to try out Claude Code on the web.
...
*Context: Highlighting the effectiveness of sandboxing in improving security and reducing interruptions.*

> Effective sandboxing requires both filesystem and network isolation.

*Context: Explaining the dual necessity for comprehensive sandboxing to ensure security.*

> We believe that others should consider adopting this technology for their own agents.

*Context: Encouraging the adoption of sandboxing technology by others to enhance security.*
...
<Note>
Originally published at [https://www.anthropic.com/engineering/claude-code-sandboxing](https://www.anthropic.com/engineering/claude-code-sandboxing).
</Note>
