...
description: 'LLM 0.32 introduces significant updates including reasoning traces, server-side tools, and enhanced logging, making it a more powerful tool for develo'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-08-04'
sourceUrl: 'https://simonwillison.net/2026/Aug/4/new-release-of-llm/#atom-everything'
topics: ["llm-updates","reasoning-traces","server-side-tools","openai-api"]
diataxisType: 'reference'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Aug/4/new-release-of-llm/#atom-everything) · 04/08/2026
</Info>

## Summary

LLM 0.32 introduces significant updates including reasoning traces, server-side tools, and enhanced logging, making it a more powerful tool for developers.

## Key Insights

> "The new version includes support for visible reasoning traces, server-side provider tools, redesigned content-addressable SQLite logs."
>
> — Overview of the new features in LLM 0.32.

> "LLM calls can now use server-side tools from various providers."
>
> — Description of new capabilities in LLM 0.32.

> "I guess LLM is an agent framework now."
>
> — Reflection on the evolution of LLM towards an agent framework.

## Topics

- [llm-updates](/kb/topics/llm-updates)
- [reasoning-traces](/kb/topics/reasoning-traces)
...
<Note>
Originally published at [https://simonwillison.net/2026/Aug/4/new-release-of-llm/#atom-everything](https://simonwillison.net/2026/Aug/4/new-release-of-llm/#atom-everything).
</Note>
