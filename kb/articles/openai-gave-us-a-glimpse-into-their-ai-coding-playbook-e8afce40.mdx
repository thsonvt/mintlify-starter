...
description: 'Every session is onboarding this new coworker [anew]. Four OpenAI engineers built the Android version of the [image generation app Sora](https://every'
icon: 'newspaper'
