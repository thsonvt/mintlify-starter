...
description: 'Moonshot AI''s Kimi K3, with 2.8 trillion parameters, is their most advanced model yet, outperforming many competitors but raising questions about benc'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-07-16'
sourceUrl: 'https://simonwillison.net/2026/Jul/16/kimi-k3/#atom-everything'
topics: ["ai-models","benchmarking","machine-learning","open-ai"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Jul/16/kimi-k3/#atom-everything) · 16/07/2026
</Info>

## Summary

Moonshot AI's Kimi K3, with 2.8 trillion parameters, is their most advanced model yet, outperforming many competitors but raising questions about benchmarking methods.

## Key Insights

> "Kimi K3 reaches an overall Elo of 1547, +732 points from Kimi K2.6 and behind only Claude Fable 5."
>
> — On the performance of Kimi K3 compared to its predecessor and competitors.

> "The biggest limitation of the pelican is that it doesn’t touch at all on the thing that matters most for today’s model: agentic tool calling."
>
> — Discussing the shortcomings of the pelican benchmark in evaluating AI models.

> "It’s a 'hello world' exercise for prompting a model."
>
> — Describing the utility of the pelican test in understanding model capabilities.
...
<Note>
Originally published at [https://simonwillison.net/2026/Jul/16/kimi-k3/#atom-everything](https://simonwillison.net/2026/Jul/16/kimi-k3/#atom-everything).
</Note>
