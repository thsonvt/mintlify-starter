...
description: '😎 The following was developed last month and has already been delivered at two conferences. If you would like for me to run a workshop similar to thi'
icon: 'newspaper'
author: 'Geoffrey Huntley'
authorId: 'geoffrey-huntley'
published: '2025-08-24'
sourceUrl: 'https://ghuntley.com/agent/'
topics: ["AI Agents","Prompt Engineering","Personal Development"]
diataxisType: 'tutorial'
---

<Info>
**Original**: [Geoffrey Huntley](https://ghuntley.com/agent/) · 24/08/2025
</Info>

## Summary

😎 The following was developed last month and has already been delivered at two conferences. If you would like for me to run a workshop similar to this at your employer, pleaseget in contact.

## Key Insights

> "300 lines of code running in a loop with LLM tokens."
>
> — Describing the simplicity and core components of building a coding agent.

> "The tech industry is almost like a conveyor belt - we always need to be learning new things."
>
> — Emphasizing the importance of continuous learning and adaptation in the tech industry.

> "Employers are now seeking individuals who can automate tasks within their organisation."
>
> — Highlighting the shift in employer expectations towards automation skills.
...
![](https://ghuntley.com/content/images/2025/07/how-to-build-an-agent.001.jpg)
...
[▶ Watch video](https://storage.ghost.io/c/06/e5/06e5d12b-0328-469d-a0d0-3a0f0ba34c46/content/media/2025/08/Let-s-build-an-agent-AFK.mp4)
...
> [**GitHub - SWE-agent/mini-swe-agent: The 100 line AI agent that solves GitHub issues or helps you in your command line. Radically simple, no huge configs, no giant monorepo—but scores 68% on SWE-bench verified!**](https://github.com/SWE-agent/mini-swe-agent?ref=ghuntley.com)
>
...
*Context: Emphasizing the importance of continuous learning and adaptation in the tech industry.*

> Employers are now seeking individuals who can automate tasks within their organisation.

*Context: Highlighting the shift in employer expectations towards automation skills.*
...
<CardGroup cols={1}>
  ...
  >
    Anthropic Engineering · how-to · 67% similar
  </Card>
</CardGroup>
