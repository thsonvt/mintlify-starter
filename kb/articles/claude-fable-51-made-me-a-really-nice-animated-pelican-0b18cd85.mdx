...
description: 'Simon Willison reviews Claude Fable 5.1, highlighting its performance on various benchmarks and its ability to generate an animated pelican.'
icon: 'newspaper'
author: 'Simon Willison'
authorId: 'simon-willison'
published: '2026-09-01'
sourceUrl: 'https://simonwillison.net/2026/Sep/1/claude-fable-5-1/'
topics: ["ai-benchmarks","animated-svg","model-evaluation","anthropic"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Simon Willison](https://simonwillison.net/2026/Sep/1/claude-fable-5-1/) · 01/09/2026
</Info>

## Summary

Simon Willison reviews Claude Fable 5.1, highlighting its performance on various benchmarks and its ability to generate an animated pelican.

## Key Insights

> "Fable 5.1 sets a new standard for coding, knowledge work, and long-running problem-solving tasks."
>
> — Announcement from Anthropic regarding the capabilities of Fable 5.1.

> "I’ll accept the slight thickness as charming rather than overengineering it."
>
> — Willison's reflection on the design choices made in the pelican SVG.

> "Now that it’s a solved benchmark, can we get the animated version?"
>
> — Comment from Hacker News regarding the Max pelican output.

## Topics

- [ai-benchmarks](/kb/topics/ai-benchmarks)
- [animated-svg](/kb/topics/animated-svg)
...
<Note>
Originally published at [https://simonwillison.net/2026/Sep/1/claude-fable-5-1/](https://simonwillison.net/2026/Sep/1/claude-fable-5-1/).
</Note>
