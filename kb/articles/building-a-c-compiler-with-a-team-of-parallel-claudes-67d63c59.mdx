...
description: 'With agent teams, multiple Claude instances work in parallel on a shared codebase without active human intervention. ![](https://www-cdn.anthropic.com'
icon: 'newspaper'
author: 'Anthropic Engineering'
authorId: 'anthropic-engineering'
published: '2026-02-12'
sourceUrl: 'https://www.anthropic.com/engineering/building-c-compiler'
topics: ["AI Agents","Agent-Native Architecture","Claude Code","Prompt Engineering"]
diataxisType: 'explanation'
---

<Info>
**Original**: [Anthropic Engineering](https://www.anthropic.com/engineering/building-c-compiler) · 12/02/2026
</Info>

## Summary

With agent teams, multiple Claude instances work in parallel on a shared codebase without active human intervention. ![](https://www-cdn.anthropic.com/images/4zrzovbb/website/7e2e39544a35760367049072406377a54f2b58c0-2554x2554.svg)

## Key Insights

> "With agent teams, multiple Claude instances work in parallel on a shared codebase without active human intervention."
>
> — Introducing the concept of agent teams for autonomous software development.

> "Over nearly 2,000 Claude Code sessions and $20,000 in API costs, the agent team produced a 100,000-line compiler."
>
> — Highlighting the scale and cost of the project to build a C compiler using Claude agents.

> "Running multiple Claude agents allows for specialization."
>
> — Discussing the benefits of parallel Claude instances in tackling different aspects of a project.
...
*Context: Introducing the concept of agent teams for autonomous software development.*

> Over nearly 2,000 Claude Code sessions and $20,000 in API costs, the agent team produced a 100,000-line compiler.

*Context: Highlighting the scale and cost of the project to build a C compiler using Claude agents.*

> Running multiple Claude agents allows for specialization.

*Context: Discussing the benefits of parallel Claude instances in tackling different aspects of a project.*
...
<CardGroup cols={1}>
  ...
  >
    Anthropic Engineering · how-to · 83% similar
  </Card>
  <Card
  ...
  >
    Anthropic Engineering · tutorial · 80% similar
  </Card>
  <Card
...
<Note>
Originally published at [https://www.anthropic.com/engineering/building-c-compiler](https://www.anthropic.com/engineering/building-c-compiler).
</Note>
